				...
				<div class="gywidth">
					<div class="detailsmartop">
						...
						<div class="gydedygetab detabdisn">
							<div class="wanglawge">
								<div class="imgoyther"></div>
							</div>
							<div class="wanglawge gldsmartop bottomposrela">
								<div class="imgdas"></div>
								<div class="sohwacezi">
									<div class="martopztwc">
										<div class="safetzt">SAFETY</div>
										<div class="ohterzit">OTHER</div>
									</div>
								</div>
								<div class="sewaimokk bottomposabso ohrewidtop"></div>
							</div>
							<div class="wanglawge swjryd jfgdgg">商务金融用地，中心内含5A级高档写字楼、SOHO公寓、酒店式公寓、商务酒店、高端独栋商务办公楼以</div>
							<div class="wanglawge jfgdgg">及配套商务等。写字楼、高档公寓、时尚酒店、休闲商业中心为一体，提供全新的国际商务标准。</div>

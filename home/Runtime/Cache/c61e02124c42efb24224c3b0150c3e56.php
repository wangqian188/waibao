				...
				<div class="gywidth">
					<div class="hsoyyedispa shouedisbetween">
						<div class="hsoyyedispa shoyedisali">
							...
							<span class="aleftwzsy">
								<span class="hsoyyedispa abuswzsy jqqiye">客户案例</span>
			...
			<div class="wanglawge">
				<div class="gywidth ">
					...
					<div class="wanglawge xifanatop">
						<div class="ifcea">Xintong International Finance Center (IFC) is located in the east of Xuchang City, east of the city's main road Weiwen Road, north of Nanhai Street, west of Xuchang Science and Technology Plaza, south </div>
					</div>
					<div class="wanglawge">

				...
				<div class="gywidth">
					<div class="detailsmartop">
						...
						<div class="gydedygetab detabdisn">
							<div class="wanglawge">
								<div class="imgoyther comsatafimg"></div>
							</div>
							<div class="wanglawge gldsmartop bottomposrela">
								<div class="imgdas comsanf"></div>
								<div class="sohwacezi">
									<div class="martopztwc">
										<div class="safetzt">SAFETY</div>
										<div class="ohterzit">COMPANY</div>
									</div>
								</div>
								<div class="sewaimokk bottomposabso ohrewidtop"></div>
							</div>
							<div class="wanglawge swjryd jfgdgg">机房是各类信息的中枢，机房工程必须保证网络和计算机等高级设备能长期而可靠地运行的工作环境。电</div>
							<div class="wanglawge jfgdgg">子化基础设施的建设，很重要的一个环节就是机房的建设。机房工程不仅集建筑、电气、</div>
							<div class="wanglawge jfgdgg">机电安装、装修装饰、网络构建等多个专业技术于一体，需要丰富的工程实施和管理经验。机房设计与施</div>
							<div class="wanglawge jfgdgg">工的优劣直接关系到机房内整个信息系统是否能稳定可靠地运行，</div>
							<div class="wanglawge jfgdgg">是否能保证各类信息通讯畅通无阻。</div>
